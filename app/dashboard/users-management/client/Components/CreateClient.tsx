...
type Role = 'ADMIN' | 'MODERATOR' | 'CLIENT' | 'OPERATOR' | 'MTO' | 'DRIVER' | '*';
...
export default function CreateClient() {
  ...
  const userMutation = useMutation({
    mutationFn: async (data: UserFormData) => {
      // console.log("data userMuration section", data);
  ...
  return (
    <div className="m-4 space-y-4 pt-2 bg-white p-4 rounded-sm">
      <Button variant="ghost" onClick={() => router.push('/dashboard/users-management/client')}>
