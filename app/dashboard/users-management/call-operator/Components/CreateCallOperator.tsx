...
type Role = 'ADMIN' | 'CALLOPERATOR' | 'CLIENT' | 'OPERATOR' | 'MTO' | 'DRIVER' | '*';
...
export default function CreateService() {
  ...
  return (
    <div className="m-4 space-y-4 pt-2 bg-white p-4 rounded-sm">
      <Button variant="ghost" onClick={() => router.push('/dashboard/users-management/call-operator')}>
        <ArrowLeft className="mr-2 h-4 w-4" /> Back
      </Button>
      <h1 className="text-2xl font-bold text-center">Create Call Operator</h1>
