...
type Role = 'ADMIN' | 'SERVICEOPERATOR' | 'CLIENT' | 'OPERATOR' | 'MTO' | 'DRIVER' | '*';
...
gender: z.string().optional()
    ...
    // }),
    allowedModules: z.array(z.string()).optional(), // Allows an empty array or undefined.
  })
...
export default function CreateService() {
  ...
  const userMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success('Service operator created successfully!');
      form.reset();
  ...
  return (
    <div className="m-4 space-y-4 pt-2 bg-white p-4 rounded-sm">
      <Button variant="ghost" onClick={() => router.push('/dashboard/users-management/service-operator')}>
        <ArrowLeft className="mr-2 h-4 w-4" /> Back
      </Button>
      <h1 className="text-2xl font-bold text-center">Create Service Operator</h1>
